...
// Join Method
/* 
    the join method allows us to concatenate all of the elements in an array. It create and then returns a string using a separator.
...
// Split Method
/*
    Splits an element into multiple elements and reurns an array. NOTE: It does not change the original array.
*/
...
// g stands global and i stands for case insensitive.
...
let darkSide = ['Darth Vader', 'Darth Plagueis', 'Emporer Palpatine', 'Count Dooku', 'General Grievous', 'Kylo Ren', 'Darth Maul'];
